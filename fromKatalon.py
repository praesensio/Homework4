...
class Stepic(unittest.TestCase):
    def setUp(self):
    ...
    def test_stepic(self):
        ...
        driver.find_element_by_id("id_registration-email").send_keys("trewq@gmail.cu")
        driver.find_element_by_id("id_registration-password1").click()
        driver.find_element_by_id("id_registration-password1").clear()
        driver.find_element_by_id("id_registration-password1").send_keys("127566ANA")
        driver.find_element_by_id("id_registration-password2").click()
        driver.find_element_by_id("id_registration-password2").clear()
        driver.find_element_by_id("id_registration-password2").send_keys("127566ANA")
        driver.find_element_by_name("registration_submit").click()
        try:
            self.assertEqual(u"Спасибо за регистрацию!",
                             driver.find_element_by_xpath("//div[@id='messages']/div/div").text)
